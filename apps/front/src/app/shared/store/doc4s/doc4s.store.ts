...
import { FilesAndPagesSource } from '../../../pages/doc4s/doc4s-edit-page/ui/files-and-pages-lists/files-and-pages-lists.component';
...
import {
  calculateSizesInMmOfImageDesc,
  ImageDesc,
  imageDescFromUploadedInfo,
} from '../../types/image-desc.types';
  ...
  withMethods(
    (
      ...
      save(): Observable<number> {
        ...
        return http
          .post<ApiResult<DocumentForSignature>>(
            cfg.config.apiAddress + BackendRoutes.doc4sUpsert,
            obj
          )
          .pipe(
            catchError((err) => {
